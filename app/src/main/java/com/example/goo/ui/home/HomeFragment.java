...
import com.example.goo.Common;
import com.example.goo.R;
...
//    }
    ...
    private void init() {
        ...
        locationCallback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                LatLng nowPosition = new LatLng(locationResult.getLastLocation().getLatitude(),
    ...
    public void onMapReady(GoogleMap googleMap) {
                        ...
                        mMap.setOnMyLocationButtonClickListener(() -> {
                            fusedLocationProviderClient.getLastLocation()
                                    ...
                                    .addOnSuccessListener(location -> {
                                       LatLng userLatLan = new LatLng(location.getLatitude(), location.getLongitude());
                                       mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(userLatLan, 18f));
                                    });
                            return true;
                        });
        ...
        try {
            ...
            if (!success)
                Log.e("MOAZ_ERROR", "Style Parsing Error");
        } catch (Resources.NotFoundException e){
            Log.e("MOAZ_ERROR", e.getMessage());
        }
    }
}